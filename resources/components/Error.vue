// resources/components/Error.vue
        ...
        <div class="container mx-auto px-6 md:px-12 relative z-10 flex items-center py-32 xl:py-40">
            <div class="w-full font-mono flex flex-col items-center relative z-10">
                <h1 class="font-extrabold text-3xl text-center text-white leading-tight mt-4">
                    Sorry for the problem, please contact the web administrator <a href="mailto:godsaveus@mail.com">here</a>
                </h1>
                <p class="font-extrabold text-xl my-44 text-white animate-bounce text-right">
